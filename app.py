...
# binance.com returns 451 from many US hosts (incl. Render). Prefer .us then .com.
BINANCE_HOSTS = (
...
def _start_loop_once():
    """Gunicorn imports app:app and never hits __main__, so start the fetch loop here."""
